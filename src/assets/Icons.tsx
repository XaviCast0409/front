...
export const Save = () => (
  <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' className='bi bi-hdd-fill' viewBox='0 0 16 16'>
...
export const Off = () => (
  <svg xmlns='http://www.w3.org/2000/svg' width='22' height='22' fill='currentColor' className='bi bi-toggle2-off' viewBox='0 0 16 16'>
...
export const On = () => (
  <svg xmlns='http://www.w3.org/2000/svg' width='22' height='22' fill='currentColor' className='bi bi-toggle2-on' viewBox='0 0 16 16'>
...
export const Loading = () => {
  return (
    <span className='spinner spinner-slow' />
  )
}
  ...
  return (
    <svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <g id='SVGRepo_iconCarrier'>
        <path d='M15 16V15C15 13.8954 15.8954 13 17 13C18.1046 13 19 13.8954 19 15V16M15 2.5V6.5M9 2.5V6.5M9 11.5H3.51733M3.51733 11.5C3.50563 11.8208 3.5 12.154 3.5 12.5C3.5 17.4094 4.64094 19.7517 8 20.6041M3.51733 11.5C3.7256 5.79277 5.84596 4 12 4C17.3679 4 19.6668 5.36399 20.3048 9.5M14 16H20V21H14V16Z' stroke='#000000' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      </g>
    </svg>
  )
}

export const BarsNav = () => {
  return (

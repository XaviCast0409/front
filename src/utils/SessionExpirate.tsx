import { SessionExpiredProps } from "utils";
      ...
      <div className="border-b border-stone-200 mx-5 py-2">
        <div className="flex gap-2 justify-between items-center">
          <div className="flex gap-10 items-center">
            <img src="" className="w-24" alt="logo" />
          </div>
        </div>
      </div>
      <div className="flex flex-col justify-center items-center h-full">
        <img
          src="https://www.svgrepo.com/show/411076/time.svg"
          alt="logo"
          className="w-40 h-40"
        />
        ...
        <a
          ...
          className="text-[--color-blue] hover:text-[--color-blue-hover]"
        >
